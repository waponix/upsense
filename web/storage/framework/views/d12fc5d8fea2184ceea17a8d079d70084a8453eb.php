<div class="c-wrapper">
    <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
        ...
        <a class="c-header-brand d-sm-none" href="#"><img class="c-header-brand"
                                                          src="<?php echo e(url('/assets/brand/logo.png')); ?>" width="97"
                                                          height="46" alt="Upsense"></a>
        ...
        <ul class="c-header-nav ml-auto mr-4">
            ...
            <li class="c-header-nav-item dropdown"><a class="c-header-nav-link" data-toggle="dropdown" href="#"
                    ...
                    <div class="c-avatar"><img class="c-avatar-img" src="<?php echo e(url('/assets/img/avatars/6.jpg')); ?>"
...
<?php /**PATH /mnt/d/Personal/Projects/upsense/resources/views/dashboard/shared/header.blade.php ENDPATH**/ ?>