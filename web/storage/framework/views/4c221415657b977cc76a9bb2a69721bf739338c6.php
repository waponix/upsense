                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4><i class="cil-blur-circular"></i> <?php echo e(__('Sensors')); ?></h4>
                        </div>
                        <div class="card-body">
...
<?php echo $__env->make('dashboard.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kevin/upsense/web/resources/views/dashboard/sensor/index.blade.php ENDPATH**/ ?>