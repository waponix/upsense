                ...
                <div class="card">
                    <div class="card-header">
                        <svg class="c-icon progress-group-icon">
                            <use
                                xlink:href="assets/icons/coreui/free-symbol-defs.svg#cui-heart"></use>
                        </svg>
                        Sensors Health
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-responsive-sm table-hover table-outline mb-0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <strong>(-30 <span class="text-warning">-10</span>)°C</strong>
                                </td>
                                <td>
                                    Kitchen
                                </td>
                                ...
                                <td>
                                    <svg class="c-icon c-icon-xl cil-wifi-signal-off">
                                        <use
                            ...
                            <tr>
                                ...
                                <td>
                                    <strong>(-25 <span class="text-warning">-5</span>)°C</strong>
                                </td>
                                <td>
                                    Pantry
                                </td>
                                ...
                                <td>
                                    <svg class="c-icon c-icon-xl">
                                        <use
                                            xlink:href="assets/icons/coreui/free-symbol-defs.svg#cui-signal-cellular-3"></use>
                                    </svg>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <svg class="c-icon c-icon-xl cil-battery-0">
                                        <use
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="progress-group">
                                <div class="progress-group-header">
                                    <svg class="c-icon progress-group-icon">
                                        <use
                                            xlink:href="assets/icons/coreui/free-symbol-defs.svg#cui-battery-slash"></use>
                                    </svg>
                                    <div>No Battery</div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="c-callout c-callout-success"><small
                                            class="text-muted">Connected</small>
                                ...
                                <div class="col-6">
                                    <div class="c-callout c-callout-danger"><small
                                            class="text-muted">Disconnected</small>
...
<?php echo $__env->make('dashboard.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/d/Personal/Projects/upsense/resources/views/dashboard/homepage.blade.php ENDPATH**/ ?>