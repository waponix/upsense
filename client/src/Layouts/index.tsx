    ...
    <ThemeProvider theme={themes(theme, dir)}>
      <>
        ...
        <Layout evaIcons={icons} dir={dir} className={pageContext.layout === 'auth' ? 'auth-layout' : ''}>
          <Router>
            <PrivateRoute path="/app/home/dashboard" component={Dashboard}></PrivateRoute>
          </Router>
          ...
          <LayoutContainer>
            ...
            <LayoutContent>
              ...
              {/*{pageContext.layout !== 'auth' && <LayoutFooter>All rights reserved {new Date().getFullYear()}</LayoutFooter>}*/}
            </LayoutContent>
          </LayoutContainer>
        </Layout>
      </>
